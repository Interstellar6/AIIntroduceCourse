/*!
 * deskpet.js — 桌宠核心（jQuery-free，经典脚本版）
 *
 * 改编自 dsh-pet：https://github.com/PC2005-cloud/dsh-pet  (MIT License)
 * 原文件为 ESM（/public/deskpet.js），此处改为经典脚本并支持相对资源基址，
 * 以便在 file:// 离线环境下也能加载。动作素材同为该项目的 MIT 授权资源。
 */
(function (root) {
"use strict";
...
const ASSET_BASE = (function () {
  if (window.__PET_ASSET_BASE__) return window.__PET_ASSET_BASE__;
  const self = (document.currentScript && document.currentScript.src) || "";
  try { return new URL("webm/", self || location.href).href; } catch (_) { return "webm/"; }
})();
...
root.DeskPetLib = { DeskPet: DeskPet, ACTIONS: ACTIONS, probeAlphaSupport: probeAlphaSupport, byCat: byCat, urlOf: urlOf, ASSET_BASE: ASSET_BASE };
})(window);
